...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium text-slate-300 hover:bg-slate-800/80 hover:text-white focus:bg-slate-800/80 focus:text-white disabled:pointer-events-none disabled:opacity-50 data-[state=open]:hover:bg-slate-800 data-[state=open]:text-white data-[state=open]:focus:bg-slate-800 data-[state=open]:bg-slate-800 focus-visible:ring-slate-500/50 outline-none transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1"
)
